...
def lerInstancias(listaArquivos):
    ...
    for file in listaArquivos:
        f = open(file, "r")
        job = f.read()
        job = job[job.index("processing times :")+19 : job.index("\nnumber of jobs")].split("\n")
        job = list(map( lambda list: [ int(i) for i in re.split(r"\s+", list.strip()) ], job))
...
files = list(numpy.repeat( [
    ...
    "flowshop/tai20_10.txt",
    "flowshop/tai20_20.txt",
    "flowshop/tai50_5.txt",
    "flowshop/tai50_10.txt",
    "flowshop/tai50_20.txt",
    "flowshop/tai100_5.txt",
    "flowshop/tai100_10.txt",
    "flowshop/tai100_20.txt",
    "flowshop/tai200_10.txt",
], 5))
...
for instancia in listaInstancias:
    ...
    for it in range (10):
        melhorSolucao = {'solucao':[], 'aptidao': 9223372036854775807 , 'tempoFinal':0}
